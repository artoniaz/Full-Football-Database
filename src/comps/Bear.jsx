...
class Bear extends Component {
  ...
  componentDidMount() {
    this.timeout = setTimeout(
      () => (this.interval = setInterval(this.addLetter, 60)),
      6000
    );
  }
    ...
    return (
      <div className="bear__frame">
        ...
        {this.state.text && (
          <p>
            {this.state.text}
            <div class="bear__arrow-down"></div>
          </p>
        )}
        {this.props.showArrow && (
          <FontAwesomeIcon icon={faLongArrowAltDown} className="bear__arrow" />
        )}
      </div>
    );
  }
