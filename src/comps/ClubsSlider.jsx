    ...
    render() {
        ...
        return (
            <div className="clubsSlider" >
                <div className="clubsSlider__minorClub clubsSlider__minorClub--left" onClick={this.props.left}>
                ...
                <div className="clubsSlider__minorClub clubsSlider__minorClub--right" onClick={this.props.right}>
